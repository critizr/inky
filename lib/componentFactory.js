...
module.exports = function(element) {
  ...
  switch (element[0].name) {
    ...
    case this.components.button:
      ...
      return format('<table %s class="%s"><tr><td><table><tr><td>%s</td></tr></table></td>%s</tr></table>', attrs, classes.join(' '), inner, expander);
    ...
    case this.components.center:
      ...
      return format('%s', $.html(element, {decodeEntities: false}));
